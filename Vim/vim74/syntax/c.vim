...
syn keyword     cComment        __in_bcount __out_bcount
syn keyword     cComment        __in_opt    __out_opt 
syn keyword     cComment        __in    __out   __inout __in_out
syn keyword     cComment        __IN    __OUT   __INOUT __IN_OUT
syn keyword     cComment        IN      OUT     INOUT
syn keyword     cType           VOID    PVOID
syn keyword     cType           BOOLEAN PBOOLEAN
syn keyword     cType           CHAR    PCHAR
syn keyword     cType           UCHAR   PUCHAR
syn keyword     cType           INT     PINT
syn keyword     cType           UINT    PUINT
syn keyword     cType           LONG    PLONG
syn keyword     cType           ULONG   PULONG
